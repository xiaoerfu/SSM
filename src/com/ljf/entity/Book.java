...
public class Book implements Serializable{
	...
	public String toString() {
		return "Book [id=" + id + ", isbn=" + isbn + ", path=" + path + ", title=" + title + ", subtitle=" + subtitle
				+ ", originalTitle=" + originalTitle + ", marketPrice=" + marketPrice + ", intro=" + intro
				+ ", binding=" + binding + ", pages=" + pages + ", author=" + author + ", publisher=" + publisher
				+ ", catalog=" + catalog + ", supply=" + supply + ", status=" + status + ", hot=" + hot + "]";
	}
