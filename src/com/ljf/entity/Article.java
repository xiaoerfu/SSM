...
public class Article implements Serializable{
	...
	public String toString() {
		return "Article [id=" + id + ", articleTitle=" + articleTitle + ", articleCreateDate=" + articleCreateDate
				+ ", articleContent=" + articleContent + ", articleClassID=" + articleClassID + ", isTop=" + isTop
				+ ", addName=" + addName + "]";
	}
